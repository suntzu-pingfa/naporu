...
 # Defining class Target has more overheads so that choose extending
String class
 def target
   self.slice(1,2).to_i
 end
...
       this_card =
         @cards.suit_cards(tf).except_two_and_joker.min_value_card
   elsif t.facedown_cards.keys.max_value_card.value >=
@cards.suit_cards(tf).max_value_card.value
       this_card =
         @cards.suit_cards(tf).except_two_and_joker.min_value_card
   elsif t.facedown_cards.keys.max_value_card.value <
@cards.suit_cards(tf).max_value_card.value
